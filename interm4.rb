...
#  if ["blue","green"].include?(color) ?  true : false
#   end
   
# end 

#puts " enter color  blue or green "

#blu_green = gets.chomp
#if color_valid(blu_green) == true
#   puts " blue or green entered"
#else 
#  puts "invalid color"
#end
#   if ["blue", "green"].include?(color) ? puts "true" : puts  "false"
#   end
#end
#str = "blue"
#color_valid(str)
